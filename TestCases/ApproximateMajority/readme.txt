This directory contains the approximate majority subject tests.
...
All use the same input file, Input-Invariants.csv, since these tests have no constraints on the input.
